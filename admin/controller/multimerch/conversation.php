		...
		foreach ($conversations as $conversation) {
			...
			$columns[] = array_merge(
				...
				array(
					...
					'author' => "<a href='".$this->url->link('customer/customer/edit', 'token=' . $this->session->data['token'] . '&customer_id=' . $conversation['conversation_from'], 'SSL')."'>" . $conversation["conversation_from_nickname"] . "</a>",
