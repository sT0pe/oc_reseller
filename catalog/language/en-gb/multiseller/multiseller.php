...
$_['ms_new_conversation'] = 'New conversation';


//Account - Offer
$_['ms_btn_create_offer'] = 'Create an offer';
$_['ms_conversation_title_offer'] = 'Inquiry about Offer (ID:%s)';

$_['ms_text_account']               = 'Account';
$_['ms_offer_title']                = 'New offer';
$_['ms_offer_title_view']           = 'Offer information';
$_['ms_account_offers']             = 'Offers';
$_['ms_account_offers_caption']     = 'Name';
...
$_['ms_view_invoice']               = 'View invoice';
$_['ms_btn_new_offer']              = 'New offer';
$_['ms_delete_offer']               = 'Are you sure you want to delete your offer?';

$_['ms_offer_caption']    = 'Caption:';
$_['ms_offer_date_start'] = 'Date start:';
$_['ms_offer_date_end']   = 'Date end:';
$_['ms_offer_delivery']   = 'Delivery:';
$_['ms_offer_service']    = 'Product service:';

$_['ms_remove_offer']     = 'Remove offer';
$_['ms_remove_selected']  = 'Remove selected';
$_['ms_save_offer']       = 'Save offer';
$_['ms_add_cart_offer']   = 'Add to cart';
$_['ms_save_new_offer']   = 'Save as new';
$_['ms_create_pdf_offer'] = 'Save and create pdf';
$_['ms_send_mail_offer']  = 'Send by mail';

$_['ms_issued_by']     = 'Issued by';
$_['ms_offer_for']     = 'Offer for';
$_['ms_offer_image']   = 'Image:';
$_['ms_offer_name']    = 'Name:';
$_['ms_offer_nip']     = 'NIP:';
$_['ms_offer_address'] = 'Address:';
$_['ms_offer_phone']   = 'Phone:';
$_['ms_offer_email']   = 'E-mail:';
$_['ms_offer_company'] = 'Company:';

$_['ms_offer_modal_title']   = 'Send the offer on email';
$_['ms_offer_modal_email']   = 'E-mail:';
$_['ms_offer_modal_close']   = 'Close';
$_['ms_offer_modal_send']    = 'Send';
$_['ms_drop_image']          = 'Drop image here or click to upload';
$_['ms_select_logo']         = 'Select your logo (displayed in your offers)';
$_['ms_column_product']        = 'Product';
$_['ms_column_purchase_price'] = 'Purchase price ex. tax';
$_['ms_column_retail_price']   = 'Retail price ex. tax';
$_['ms_column_discount']       = 'Discount, %';
$_['ms_column_client_price']   = 'Price for client ex. tax';
$_['ms_column_final_price']    = 'Price for client incl. tax';
$_['ms_column_tax']            = 'Tax, %';

$_['ms_netto']        = 'Netto';
$_['ms_brutto']       = 'Brutto';
$_['ms_price_netto']  = 'Price netto';
$_['ms_price_brutto'] = 'Price brutto';
$_['ms_total_netto']  = 'Total netto:';
$_['ms_total_brutto'] = 'Total brutto:';
$_['ms_total_price']  = 'Total price: ';
$_['ms_total_seller'] = 'Total for seller:';
$_['ms_total_client'] = 'Total for client:';
$_['ms_profit']       = 'Your profit:';
$_['ms_total_service']= 'Total: ';
$_['ms_service_final']= 'Price incl. tax';

$_['ms_tab_products']       = 'Products';
$_['ms_tab_services']       = 'Services';
$_['ms_find_products']      = 'Find products:';
$_['ms_placeholder_search'] = 'Search';
$_['ms_service_text']       = 'Service';
$_['ms_service_price']      = 'Price ex. tax';
$_['ms_model_column']       = 'Model';
$_['ms_quantity_column']    = 'Quantity';
$_['ms_total_column']       = 'Total';
$_['ms_column_price']       = 'Price';

$_['ms_placeholder_service_name'] = 'Service name';
$_['ms_title_add_service']       = 'Add new service';
$_['ms_view_conversation'] = 'View conversation';

$_['ms_remove_offer_success'] = 'Offer have been removed!';
$_['ms_offer_limit_error']    = 'Sorry! You have reached your limit for offers!';
$_['ms_email_send_success']   = 'E-mail was successfully send!';
$_['ms_add_cart_success']     = 'Products was added to the cart!';
$_['ms_add_cart_error']       = 'Nothing to add!';
$_['ms_send_mail_error']      = 'You need to save offer first!';

$_['ms_validate_caption'] = 'Caption must be between 1 and 32 characters!';
$_['ms_validate_date']    = 'Date does not appear to be valid!';
$_['ms_validate_name']    = 'Name must be between 1 and 32 characters!';
$_['ms_validate_address'] = 'Address must be between 3 and 128 characters!';
$_['ms_validate_phone']   = 'Telephone must be between 3 and 32 characters!';
$_['ms_validate_email']   = 'E-mail does not appear to be valid!';

$_['ms_offer_details']   = 'Offer Details';
$_['ms_mail_offer_id']   = 'Offer ID: ';
