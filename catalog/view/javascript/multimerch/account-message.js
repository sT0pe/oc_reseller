$(function() {
	...
	$("#ms-message-reply").click(function() {
		$.ajax({
            ...
            beforeSend: function() {
                $('#ms-message-form #ms-message-reply').hide().before('<span class="wait">&nbsp;<img src="catalog/view/theme/default/image/loading.gif" alt="" /></span>');
            },
    ...
    $(document).on('click', '.ms-message-upload', function() {
        ...
        timer = setInterval(function() {
            if ($('#form-upload input[name="file"]').val() != '') {
                ...
                $.ajax({
                    url: 'index.php?route=account/msmessage/jxUploadAttachment',
                    type: 'post',
                    dataType: 'json',
